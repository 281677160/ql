...
curl -s --connect-timeout 3 https://cdn.jsdelivr.net/gh/xtoys/Scripts@main/dragon/shell/config.sample.sh > $sample_shell_path
...
curl -s --connect-timeout 3 https://cdn.jsdelivr.net/gh/xtoys/Scripts@main/dragon/shell/extra.sh > $extra_shell_path
...
curl -s --connect-timeout 3 https://cdn.jsdelivr.net/gh/xtoys/Scripts@main/dragon/shell/code.sh > $code_shell_path
...
# 下载 task_before.sh
curl -s --connect-timeout 3 https://cdn.jsdelivr.net/gh/xtoys/Scripts@main/dragon/shell/task_before.sh > $task_before_shell_path
