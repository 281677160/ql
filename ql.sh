...
[[ ! "$USER" == "root" ]] && {
	...
	case $QLJB in
		1)
			bash -c "$(curl -fsSL https://cdn.jsdelivr.net/gh/281677160/ql@main/Aaron-lv/tjzl11.sh)"
		break
		;;
		2)
			bash -c "$(curl -fsSL https://cdn.jsdelivr.net/gh/281677160/ql@main/feverrun/zdzl11.sh)"
		break
		;;
		3)
			echo
